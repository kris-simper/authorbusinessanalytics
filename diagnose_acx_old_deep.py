"""Deep diagnostic of legacy ACX format - dump all rows from Sales Details."""
...
filepath = files[0]
print(f"[INFO] Deep inspecting: {filepath.name}")
print("=" * 60)

df = pd.read_excel(filepath, engine='xlrd', sheet_name='Sales Details', header=None)
